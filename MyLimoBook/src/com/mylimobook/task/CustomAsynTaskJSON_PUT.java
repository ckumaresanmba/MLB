...
public class CustomAsynTaskJSON_PUT extends AsyncTask<String, Void, String> {
	...
	public CustomAsynTaskJSON_PUT(Activity activity ,int taskID,String progressMsg,String URL,JSONObject jsonString )
	{
